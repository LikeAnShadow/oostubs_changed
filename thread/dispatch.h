...
public:
    /*
     * Der Konstruktor initialisiert den Life-Pointer mit Null, um
     * anzuzeigen, dass noch keine Koroutine bekannt ist.
     */
    Dispatcher ();

    /*
     * Mit dieser Methode wird die Koroutine first im Life-Pointer vermerkt
     * und gestartet.
     */
